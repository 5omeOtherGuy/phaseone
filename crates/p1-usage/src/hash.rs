//! A minimal SHA-256, kept in this crate to preserve the std-only boundary.
//!
//! The live pane prints the hash of the binary it is running so a stale build cannot be
//! mistaken for the candidate. That is the only use; it is not a security primitive here.

/// FIPS PUB 180-4 SHA-256, lowercase hex.
