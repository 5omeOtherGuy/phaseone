...
The owner's 22:45 order (via XO) settles the roles in §Roles: `workflow_start` may invoke the Opus 5.5 medium judge role inside this workflow only; it is not a new lead.
