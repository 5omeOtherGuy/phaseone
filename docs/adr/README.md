...
| ADR-0061 | [A route may be self-contained: store-only credentials never read another tool's login](0061-a-route-may-be-self-contained-store-only-credentials-never-read-another-tool-s-login.md) | proposed | 2026-09-24 | owner |
<!-- adr-index:end -->
