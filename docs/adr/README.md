...
| ADR-0036 | [Context control is a summarizing policy module with a durable, validated replacement](0035-context-control-is-a-summarizing-policy-module-with-a-durable-validated-replacement.md) | accepted | 2026-09-20 | lead |
<!-- adr-index:end -->
