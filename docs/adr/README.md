...
| ADR-0062 | [p1 installs from its release channel into a prefix and the binary names its commit](0062-p1-installs-from-its-release-channel-into-a-prefix-and-the-binary-names-its-commit.md) | proposed | 2026-09-24 | lead |
<!-- adr-index:end -->
