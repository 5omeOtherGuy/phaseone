...
| `textengine.rs` | parser, width, ZWJ, wrap/truncate families | MIT | unicode-segmentation, unicode-width; zwj_probe reference | **Adapt selected symbols above**, remainder Blocked |
